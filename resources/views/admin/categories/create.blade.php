...
@section('title', 'Fashion - Add New Category')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">إضافة فئة جديدة</h1>
                    <p class="text-gray-600 mt-2">أضف فئة جديدة للمتجر</p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div id="image-preview" class="mt-3 hidden">
                        <p class="text-sm text-gray-600 mb-2">معاينة الصورة:</p>
